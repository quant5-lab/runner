...
generate_data() {
    ...
    go run tests/golden/cmd/gendata/main.go -symbol AAPL -timeframe 1h -bars 500 -output tests/golden/fixtures/data/AAPL-1h.json
    ...
    go run tests/golden/cmd/gendata/main.go -symbol BTCUSDT -timeframe 1h -bars 500 -output tests/golden/fixtures/data/BTCUSDT-1h.json
    ...
    go run tests/golden/cmd/gendata/main.go -symbol SBERP -timeframe 1h -bars 500 -output tests/golden/fixtures/data/SBERP-1h.json
