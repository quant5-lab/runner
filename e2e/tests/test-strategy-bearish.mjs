...
const mockProvider = new MockProviderManager({ dataPattern: 'bearish', basePrice: 100, amplitude: 10 });
...
if ((shortOnly && negativeOnly) || (noLongSignals && negativeOnly && shortSig.every(v => v === 0))) {
