...
| **27** | **Runtime** | `timeframe.period` runtime resolution | FIXED | Now resolves to ctx.Timeframe at runtime via extractTimeframeCode() MemberExpression handling | utbot-quantnomad.pine |
