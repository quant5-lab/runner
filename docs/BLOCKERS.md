...
| **13** | **Codegen** | `ta.atr()` literal period requirement | ✅ **FIXED** | Now supports input() variables via constEvaluator. supertrend.pine now fails on different blocker (lowest in condition) |
