...
func TestBuiltinMemberExpression_TrSupport(t *testing.T) {
	...
	t.Run("ta.tr MemberExpression", func(t *testing.T) {
		...
		code, resolved := handler.TryResolveMemberExpression(taTrExpr, BarLoopScope)
		if !resolved {
	...
	t.Run("bare tr identifier", func(t *testing.T) {
		...
		code, resolved := handler.TryResolveIdentifier(trIdentifier, BarLoopScope)
		if !resolved {
...
func TestBuiltinIdentifier_AllBuiltinsSupported(t *testing.T) {
	...
	for _, builtin := range builtins {
		t.Run(builtin.name, func(t *testing.T) {
			...
			code, resolved := handler.TryResolveIdentifier(identifier, BarLoopScope)
			if !resolved {
