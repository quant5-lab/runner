...
function createContainer(providerChain, defaultConfig) {
    ...
    container
        ...
        .register('configurationBuilder', () => new ConfigurationBuilder(defaultConfig), true)
        .register('fileExporter', () => new FileExporter(), true)
        .register('tradingOrchestrator', (container) => new TradingOrchestrator(
